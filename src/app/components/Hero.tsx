...
export default function Hero() {
  return (
    <div className="w-full h-screen bg-cover flex justify-evenly items-center" style={{backgroundImage: `url('/hero.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
